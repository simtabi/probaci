#!/usr/bin/env bash
#
# probaci installer for macOS and Linux.
#
#   curl -fsSL https://opensource.simtabi.com/install/probaci | bash
#   curl -fsSL https://opensource.simtabi.com/install/probaci | bash -s v0.1.0
#
# Windows users: use scripts/install.ps1 (irm ... | iex) or download the bare
# probaci_windows_<arch>.exe from the GitHub releases page.
#
set -euo pipefail
...
# any project name (uppercase, non-alnum -> '_'): e.g. probaci -> "<PREFIX>".
